          ...
          <Container>
            ...
            <div className="max-w-3xl mx-auto mb-16">
              <div className="p-8 rounded-2xl border border-slate-800 bg-gradient-to-b from-slate-800/40 to-slate-900/80">
                ...
                <p className="text-slate-400 leading-relaxed mb-4">
                  I'm Sean, founder of Quantum Transfer Group. I've been in the crypto space for years and got tired of the same CSV headaches every April. TaxFormatter is the tool I wished existed.
                </p>
                <a
