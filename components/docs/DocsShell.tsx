...
/**
 * Shell for documentation pages: header, sidebar navigation, and content area.
 * Split out of app/docs/layout.tsx so that layout can stay a server component
 * and export per-page metadata (this shell needs client-side scroll state).
 */
